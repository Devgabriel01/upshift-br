        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <item.icon className={`w-4 h-4 relative z-10 ${isActive ? "text-orange-400" : "text-gray-400 group-hover:text-white"}`} />
              <span className={`relative z-10 ${isActive ? "text-orange-400 font-medium" : "text-gray-400 group-hover:text-white"}`}>
                {item.label}
              </span>
            </Link>
          );
